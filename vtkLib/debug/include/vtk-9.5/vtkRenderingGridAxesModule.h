...
#      define VTKRENDERINGGRIDAXES_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define VTKRENDERINGGRIDAXES_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define VTKRENDERINGGRIDAXES_DEPRECATED __declspec(deprecated)
#endif
